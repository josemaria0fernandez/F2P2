...
void motorADCON(){
    ...
    switch(state){
        ...
        case 1:
            ...
            break;
        case 2:
            if(JoyPosition > 5 && JoyPosition < 250 ){
                isCentered = 1;
            }
            if(isCentered && (JoyPosition < 5 || JoyPosition > 250)) {
                isCentered = 0;
                if(JoyPosition > 250) direction = 'U';
                if(JoyPosition < 5) direction = 'D';
            ...
            if(!isCentered && (JoyPosition < 'D' || JoyPosition > 'U')){
                state = 0;
            }
            state = 0;
            break;
